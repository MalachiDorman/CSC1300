...
int main() {
    int bear_hit = 100, wolves_hit = 100, lady_hit = 100, you_hit = 100, dragon_hit = 500; // Initialized you_hit
    ...
    do {
        ...
        while(toupper(choice.at(0)) != 'N' && choice.at(0) != 'S' 
        ...
        switch(toupper(choice.at(0))) {
            case 'N':
                ...
                // Check if the user input contains "fight"
                ...
                } else if (user_input.find("befriend") != string::npos) { // Checks if the input contains "befriend"
                    if (bear_friend) {
                        ...
                        friend_modifier++;
                        bear_friend = true; // Update the bear's friendship status
                    }
                    cout << "\nThe bears walk you back to your tent.";
            
                } else if (user_input.find("run") != string::npos) { // Checks if the input contains "run"
                    cout << "\n\nYou ran away like a coward. The bear is unimpressed.";
                    cout << "\nI suppose you're not dead though.";
                    cout << "\nSo you return to the tent.";
            
                } else {
                    // If the input does not match any valid action, clear the input and prompt the user again
                    user_input.clear();
                    cout << "I did not understand your choice (hint: use the keywords fight, befriend, or run away)." << endl;
                    cout << "What would you like to do? ";
                }
            
            } while (user_input.find("fight") == string::npos && user_input.find("befriend") == string::npos && user_input.find("run") == string::npos); // Loop until a valid action is entered
            ...
            case 'S':
                ...
                } while (user_input.find("fight") == string::npos && user_input.find("befriend") == string::npos && user_input.find("run") == string::npos); // Fixed condition
            ...
            case 'E':
                ...
                } while (user_input.find("fight") == string::npos && user_input.find("adopt") == string::npos ); // Fixed condition
            ...
            case 'W':
                ...
                do {
                    ...
                    if (user_input.find("explore") != string::npos) {
                        ...
                        while (dragon_hit > 0 && you_hit > 0) { // Changed || to && so fight ends when either hits 0
                            ...
                            if (friend_modifier > 0 && dragon_hit > 0 && you_hit > 0) { // Only apply friendship bonus during active fight
                        ...
                        user_input.find("run") == string::npos);
